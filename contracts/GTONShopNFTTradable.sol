...
/**
 * @title GTONShopNFTTradable
 * GTONShopNFTTradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract GTONShopNFTTradable is ERC721, Ownable {
