...
/**
 * @title GTONShopNFTTradablePrivate
 * GTONShopNFTTradablePrivate - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract GTONShopNFTTradablePrivate is ERC721, Ownable {
    ...
    */
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist GTONShop auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist GTONShop contracts to enable gas-less listings.
     */
