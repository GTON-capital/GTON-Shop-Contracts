...
import "./GTONShopArtTradable.sol";

contract GTONShopArtFactory is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new GTONShopArtTradable contract
        ...
        returns (address)
    {
        ...
        GTONShopArtTradable nft = new GTONShopArtTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
